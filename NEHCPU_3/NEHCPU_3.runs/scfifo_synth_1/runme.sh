...
HD_PWD='G:/AbandonMIPS/AbandonMIPS/v1.0/Abandon_MIPS/src/NEHCPU_3/NEHCPU_3.runs/scfifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scfifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scfifo.tcl
