...
HD_PWD='G:/AbandonMIPS/AbandonMIPS/v1.0/Abandon_MIPS/src/NEHCPU_3/NEHCPU_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nehcpu_sopc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nehcpu_sopc.tcl -notrace
