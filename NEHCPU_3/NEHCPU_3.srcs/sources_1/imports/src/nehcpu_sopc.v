...
module nehcpu_sopc(
    ...
    wire vga_ack_i;
    wire             vgaclk;
    assign vgaclk = clk50M;
    assign led = vgalamp[15:0];
    //assign led = {red_o, green_o, blue_o, vgaclk, hsync_o, vsync_o, 4'b0};
    //assign led = {trueled[19:16], sram_addr_o[19:16], sram_we_o,sram_cyc_o,sram_stb_o,sram_ack_i,4'b0 };
    //assign led = {uart_we_o, uart_ack_i, uart_stb_o, uart_cyc_o, uart_sel_o, 4'b0, uart_addr_o[3:0]};
    ...
    nehcpu nehcpu0(
        ...
        .iwishbone_data_i(inst_data_o),
        .iwishbone_ack_i(inst_ack_o),
        .iwishbone_addr_o(inst_addr_i),
        .iwishbone_data_o(inst_data_i),
        .iwishbone_we_o(inst_we_i),
        .iwishbone_sel_o(inst_sel_i),
        .iwishbone_stb_o(inst_stb_i),
        .iwishbone_cyc_o(inst_cyc_i),
        ...
        .dwishbone_data_i(data_data_o),
        .dwishbone_ack_i(data_ack_o),
        .dwishbone_addr_o(data_addr_i),
        .dwishbone_data_o(data_data_i),
        .dwishbone_we_o(data_we_i),
        .dwishbone_sel_o(data_sel_i),
        .dwishbone_stb_o(data_stb_i),
        .dwishbone_cyc_o(data_cyc_i),
    ...
    uart_controller uart_controller0(
        .CLK(clk_o),
            .RESET(rst),
            .UART_ADR_I(uart_addr_o),
            .UART_DAT_I(uart_data_o),
            .UART_DAT_O(uart_data_i),
            .UART_STB_I(uart_stb_o),
            .UART_CYC_I(uart_cyc_o),
            .UART_WE_I(uart_we_o),
            .UART_SEL_I(uart_sel_o),
            .UART_ACK_O(uart_ack_i),
            .SIN(uart_in),
            .SOUT(uart_out),
            .INTR(uart_int)
       );
      //vga control
      vga_slave vga_slave0(
                        .lamp(vgalamp),
                        .clk(vgaclk),
                        .clk_i(clk_o),
                        .rst_i(rst),
                        .wb_addr_i(vga_addr_o),
                                .wb_data_i(vga_data_o),
                                .wb_data_o(vga_data_i),
                                .wb_we_i(vga_we_o),
                                .wb_stb_i(vga_stb_o), 
                                .wb_cyc_i(vga_cyc_o), 
                                .wb_ack_o(vga_ack_i), 
    ...
    .s4_data_i(vga_data_i), 
    .s4_data_o(vga_data_o), 
    .s4_addr_o(vga_addr_o), 
    .s4_sel_o(vga_sel_o), 
    .s4_we_o(vga_we_o), 
    .s4_cyc_o(vga_cyc_o),
