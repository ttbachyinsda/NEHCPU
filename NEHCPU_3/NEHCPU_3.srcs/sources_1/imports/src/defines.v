...
// macro defines associated with Fake_RAM
`define RamNumLog2 10
`define RamNum (1 << `RamNumLog2)

`define VGA_ADDR_BUS                17:0
`define VGA_DATA_BUS                8:0

`define VGA_OFFSET_BUS              8:0

`define VGA_HVISIBLE                800
`define VGA_HBLANK_START            856
`define VGA_HBLANK_END              976
`define VGA_HEND                    1040

`define VGA_VVISIBLE                600
`define VGA_VBLANK_START            637
`define VGA_VBLANK_END              643
`define VGA_VEND                    666
`define H_SYNC_PULSE 120
