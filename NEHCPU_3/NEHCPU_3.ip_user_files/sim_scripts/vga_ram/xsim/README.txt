...
#
# Generated by export_simulation on Sun Jul 23 14:56:52 +0800 2017
#
################################################################################
...
switch to the './vga_ram.sh' script.

./vga_ram.sh -reset_run
...
./vga_ram.sh -noclean_files

For more information on the script, please type './vga_ram.sh -help'.
