...
--               G:/prj5_apollo-master-3bd193289902d4aded5121b45787793f054fa79c/mips/NEHCPU/NEHCPU.runs/clk_func_synth_1/clk_func_sim_netlist.vhdl
-- Design      : clk_func
...
entity clk_func_clk_func_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_func_clk_func_clk_wiz : entity is "clk_func_clk_wiz";
end clk_func_clk_func_clk_wiz;

architecture STRUCTURE of clk_func_clk_func_clk_wiz is
  signal CLK_IN1_clk_func : STD_LOGIC;
  signal clk_out1_clk_func : STD_LOGIC;
  signal clk_out1_clk_func_en_clk : STD_LOGIC;
  signal clk_out2_clk_func : STD_LOGIC;
  signal clk_out2_clk_func_en_clk : STD_LOGIC;
  signal clkfbout_buf_clk_func : STD_LOGIC;
  signal clkfbout_clk_func : STD_LOGIC;
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => clk_out1_clk_func,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_clk_func,
...
entity clk_func is
  ...
  attribute NotValidForBitStream of clk_func : entity is true;
end clk_func;

architecture STRUCTURE of clk_func is
begin
inst: entity work.clk_func_clk_func_clk_wiz
     port map (
      CLK_IN1 => CLK_IN1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2
