...
HD_PWD='G:/prj5_apollo-master-3bd193289902d4aded5121b45787793f054fa79c/mips/NEHCPU/NEHCPU.runs/clk_func_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_func.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_func.tcl
