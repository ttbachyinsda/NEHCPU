...
HD_PWD='G:/prj5_apollo-master-3bd193289902d4aded5121b45787793f054fa79c/mips/NEHCPU/NEHCPU.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log apollo_cpu_sopc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apollo_cpu_sopc.tcl
