...
HD_PWD='G:/prj5_apollo-master-3bd193289902d4aded5121b45787793f054fa79c/mips/NEHCPU/NEHCPU.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log apollo_cpu_sopc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apollo_cpu_sopc.tcl -notrace
