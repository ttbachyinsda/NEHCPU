...
#
# Generated by export_simulation on Sat Jul 08 16:20:02 +0800 2017
#
################################################################################
...
switch to the './clk_func.sh' script.

./clk_func.sh -reset_run
...
./clk_func.sh -noclean_files

For more information on the script, please type './clk_func.sh -help'.
